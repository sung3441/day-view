package com.side.dayv.global.util;
...
public class ErrorMessage {
    ...
    public static final String IMPOSSIBLE_MY_CHANNEL_UPDATE = "내 일정은 수정 할 수 없습니다";
    // subscribe
    ...
    public static final String BAD_REQUEST_MANAGE_UNSUBSCRIBE = "매니저 권한을 가지고 있는 구독은 취소할 수 없습니다.";
    public static final String BAD_REQUEST_PERMISSION = "다른 계정의 구독을 수정 또는 삭제할 수 없습니다.";

    public static final String MODIFY_NO_PERMISSION = "수정할 권한이 없습니다";

    public static final String RECORD_NOT_FOUND = "해당 일정을 찾을 수 없습니다.";
}
